	...
	<div class="container well">
        <div class="row main">
            <div class="" >
                ...
                <form action="abm/alta_folio.php" method="post">
                ...
                <div class="form-group  col-md-4">
                          ...
                          <input type="text" class="form-control"  maxlength="50"  id="txtFolio" name="txtFolio" value="" required="required">
                </div>
                ...
                <div class="form-group  col-md-4">
                    <div align="center">
                            ...
                            <input type="submit" value="CREAR FOLIO" class="btn btn-primary"  id="InputSubmit">
                    </div>
                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            <td>
                                             <?php echo $f->nIdFolio;?></td>
                                            <td><?php echo $f->sFolio;?></td>
                                            <td><?php 
                                            $f->nIdPeriodo=$_REQUEST['nIdP'];
                                            
                                            //echo $oG->totalPorCarreraYPeriodo();
                                            ?></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
