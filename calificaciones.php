...
<script type="text/javascript">
   function verHorario(sPeriodo,sNomDoc,sPe){
        
       $("#formDocente").submit(function(e) {
        var url = "ver_horario_docente.php?cal=1&calis=a&sPe="+sPeriodo+"&sNomDoc="+sNomDoc+"&sPe2="+sPe; // El script a dónde se realizará la petición.
         $.ajax({
           type: "POST",
           url: url,
    ...
    function verFolios(sPeriodo,sNomDoc,sPe){
     ...
     function asignarCals(nIdGrup,nIdAsig,nIdPe){
        $("#calificaciones").html("");
       $(document).ready(function() {
        var url = "asignar_calificaciones.php?nIdGE="+nIdGrup+"&nIdAsig="+nIdAsig+"&nIdPe="+nIdPe; // El script a dónde se realizará la petición.
         $.ajax({
	...
	<div class="" >
        ...
        <div class="container-fluid">
            ...
            <br>
                ...
                Estimado Docente : <br>
                De click en el botón <u>Materias en Periodo</u>, posteriormente de click en el grupo al cual asignara la calificación parcial, tome en cuenta que la fecha <strong>límite</strong> para subir por parcial están establecidas, por lo que no habrá prórroga para subir fuera de ellas, verifique al finalizar que sus calificaciones fueron asignadas correctamente por usted, las suficientes veces hasta que el sistema bloquee la subida de calificación por fecha vencida. 
...
$meses=array("01" => "E", "02" => "F", "03" => "M", "04" => "A","05" => "M","06" => "J", "07" =>"J", "08" =>"A", "09" => "S", "10" => "O","11" => "N", "12" => "D");
                                    ...
                                    <button class="btn btn-primary" onclick="return verHorario('<?php echo $p->sPeriodo;?>','<?php echo $oCol->sNombre." ".$oCol->sApp." ".$oCol->sApm." - ".$oCol->sMatricula; ?>','<?php echo $nIni."-".$nFin; ?>');">MATERIAS EN EL PERIODO</button></center>
            ...
            <?php 
               ...
               $oParc=new Parcial();
               $arrP=null;
               $oParc->nIdPeriodo=$nIdPeriod;
               $arrP=$oParc->buscarPorPeriodo();
               if($arrP != null){
                    foreach ($arrP as $key ) {
                        echo "PARCIAL : ".($key->sParcial == '4' ? 'FINAL' : $key->sParcial)."   ";
                        echo "FECHA LIMITE PARA SUBIR CALIFICACIONES : UN DÍA ANTES DE:  ".$key->dFechaLimite."<br>";
...
<section class="content">
        <div class="container-fluid">
            ...
            <br>
                ...
                <p>
               Estimado Docente Titular: <br>
               De click en el botón <u>Folios en Periodo</u>, posteriormente de click en el Folio al cual imprimirá la lista para firmar, recuerde que al igual que la asignación de calificaciones, igual tiene fecha <strong>límite</strong>  por parcial, por lo que no habrá prórroga para imprimir fuera de ellas,
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            ?>
                            <form action="" method="post" id="formFolio">
                              <div id="cambio">
                                   <label> </label>
                                      <div class="form-group">
                                      <label>Docente: </label>
...
$meses=array("01" => "E", "02" => "F", "03" => "M", "04" => "A","05" => "M","06" => "J", "07" =>"J", "08" =>"A", "09" => "S", "10" => "O","11" => "N", "12" => "D");
                                    ...
                                    <button class="btn btn-primary" onclick="return verFolios('<?php echo $p->sPeriodo;?>','<?php echo $oCol->sNombre." ".$oCol->sApp." ".$oCol->sApm." - ".$oCol->sMatricula; ?>','<?php echo $nIni."-".$nFin; ?>');">FOLIOS EN EL PERIODO</button></center>
            ...
            <?php 
               ...
               if($arrP != null){
                    foreach ($arrP as $key ) {
                        echo "PARCIAL : ".($key->sParcial == '4' ? 'FINAL' : $key->sParcial)."   ";
                        echo "FECHA LIMITE PARA IMPRIMIR CALIFICACIONES ".$key->dFechaLimite."<br>";
