                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            <td><a href="crear_grupos.php?nIdG=<?php echo $g->nIdGrupo;?>&nIdC=<?php echo $_REQUEST['nIdC'];?>&nIdP=<?php echo $_REQUEST['nIdP'];?>&sNom=<?php echo $_REQUEST['sNom'];?>&sPer=<?php echo $_REQUEST['sPer'];?>&nIdFolio=<?php echo $g->nIdFolios;?>"> <?php echo $g->sNombre;?></a></td>
