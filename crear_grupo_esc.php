	...
	<div class="container well">
        <div class="row main">
            <div class="" >
                ...
                <form action="abm/alta_grupo_esc.php" method="post">
                ...
                <input type="hidden" class="form-control"  maxlength="50"  id="txtCalle" name="nIdC" value="<?php echo $_REQUEST['nIdC'];?>">
                 ...
                 <div class="form-group  col-md-4">
                          ...
                          <input type="hidden" name="txtFolio" value="<?php echo $_REQUEST['nIdFolio']?>">
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>FOLIO</th>
                                            <th>NUMERO DE ALUMNOS EN FOLIO</th>
                                           
                                            <th>NUMERO DE ALUMNOS EN GRUPO</th>
                                            <th></th>
                                            <th></th>
                                    ...
                                    $oG->nIdFolios=$_REQUEST["nIdFolio"];
                                    $arrGrupos=null;
                                    $arrGrupos=$oG->buscarGrupoPorCarreraYPeriodo2();
                                    if($arrGrupos!=null){
                                    	$g=null;
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            <td><a href="asignar_alumnos_grupos2.php?nIdG=<?php echo $g->nIdGrupo;?>&nIdC=<?php echo $_REQUEST['nIdC'];?>&nIdP=<?php echo $_REQUEST['nIdP'];?>&sNom=<?php echo $_REQUEST['sNom'];?>&sPer=<?php echo $_REQUEST['sPer'];?>&nIdGE=<?php echo $g->nIdGrupoEsc;?>&nIdFolio=<?php echo $_REQUEST['nIdFolio'];?>"> <?php echo $g->sNombre;?></a></td>
                                            ...
                                            ?></td>
                                            <td>
                                            	 <?php echo $g->totalInscritosAlGrupo(); ?>
                                            </td>
                                            <td></td>
                                            <td></td>
                                        </tr>
