                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            <td><a href="asignar_horario.php?nIdG=<?php echo $g->nIdGrupo;?>&nIdC=<?php echo $_REQUEST['nIdC'];?>&nIdP=<?php echo $_REQUEST['nIdP'];?>&sNom=<?php echo $_REQUEST['sNom'];?>&sPer=<?php echo $_REQUEST['sPer'];?>&nIdGE=<?php echo $g->nIdGrupoEsc;?>&sFolio=<?php echo $g->sFolio; ?>"> <?php echo $g->sNombre;?></a></td>
